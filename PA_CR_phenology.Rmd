...
dat <- list(ones = rep(1, times = nrow(CH)), 
            DATE_IN = DATE_IN,
            DATE_OUT = DATE_OUT,
            CENSORED_IN = CENSORED_IN,
            CENSORED_OUT = CENSORED_OUT,
            CONSTRAINED_DATA = CONSTRAINED_DATA,
            DOY = DOY,
            CONSTRAINED_DOY = CONSTRAINED_DOY,
            constraint_s0 = rep(1, times = 3))
...
inits <- function() list(h = c(2, 3.18, 1.6, -0.3, 0) + rnorm(n = 5, mean = 0, sd = 0.25),
                         
                         f  = c(-0.40, 0.20, -0.40, 0, 0, 0) + rnorm(n = 6, mean = 0, sd = 0.25), 
                         g  = c(0.8, 1.4 , 2.2, 0) + rnorm(n = 4, mean = 0, sd = 0.25), 
                         
                         e  = rnorm(n = 9, mean = 0, sd = 0.25),
                         
                         a = rnorm(n = 6, mean = 0, sd = 0.25),
                         b = rnorm(n = 7, mean = 0, sd = 0.25),
                         ...
                         # z = z_inits,
                         c = rnorm(n = 3, mean = 0, sd = 1),
                         sigma_rho = runif(1, min = 0, max = 1),
                         sigma_day_in = runif(1, min = 0.5, max = 1),
                         d = rnorm(n = 4, mean = 0, sd = 1),
                         sigma_psi = runif(1, min = 0, max = 1),
                         sigma_day_out = runif(1, min = 0.5, max = 1),
                         DATE_IN = date_in_inits,
                         DATE_OUT = date_out_inits,
                         
                         j = c(0, 0.2) + rnorm(n = 2, mean = 0, sd = 0.25),
...
params <- c("h", 
            ...
            "c", "rho", "sigma_rho",  "sigma_day_in", 
            "d", "psi", "sigma_psi",  "sigma_day_out",
            "j", "sigma_doy", "nu", "sigma_nu")
```
...
PA_CR_phenology <- nimbleCode({
  ...
  for (i in 1:n_ind) {
    ...
    E0[5, 11, i] <- 0
    E0[5, 12, i] <- 0
    E0[5, 13, i] <- KHI[i, first[i]] * ( 1-P0[i] )
    E0[5, 14, i] <- 0
    E0[5, 15, i] <- 0
    E0[5, 16, i] <- KHI[i, first[i]] * P0[i]
    E0[5, 17, i] <- 0
    E0[5, 18, i] <- 0
    E0[5, 19, i] <- 0
    ...
    E0[6, 11, i] <- 0
    E0[6, 12, i] <- 0
    E0[6, 13, i] <- KHI[i, first[i]] * ( 1-P0[i] ) * AGE_5[i, first[i]]
    E0[6, 14, i] <- 0
    E0[6, 15, i] <- KHI[i, first[i]] * ( 1-P0[i] ) * ( 1-AGE_5[i, first[i]] )
    E0[6, 16, i] <- 0
    E0[6, 17, i] <- 0
    E0[6, 18, i] <- 0
    E0[6, 19, i] <- 0
    ...
    E0[7, 11, i] <- 0
    E0[7, 12, i] <- 0
    E0[7, 13, i] <- KHI[i, first[i]] * ( 1-P0[i] ) * AGE_5[i, first[i]]
    E0[7, 14, i] <- 0
    E0[7, 15, i] <- KHI[i, first[i]] * ( 1-P0[i] ) * ( 1-AGE_5[i, first[i]] )
    E0[7, 16, i] <- 0
    E0[7, 17, i] <- 0
    E0[7, 18, i] <- 0
    E0[7, 19, i] <- 0
    ...
    E0[8, 12, i] <- 0
    E0[8, 13, i] <- 0
    E0[8, 14, i] <- KHI[i, first[i]] * ( 1-P0[i] )
    E0[8, 15, i] <- 0
    E0[8, 16, i] <- 0
    E0[8, 17, i] <- 0
    E0[8, 18, i] <- 0
    ...
    E0[9, 12, i] <- 0
    E0[9, 13, i] <- 0
    E0[9, 14, i] <- KHI[i, first[i]] * ( 1-P0[i] )
    E0[9, 15, i] <- 0
    E0[9, 16, i] <- 0
    E0[9, 17, i] <- 0
    E0[9, 18, i] <- 0
    ...
    E0[10, 7, i] <- 0
    E0[10, 8, i] <- 0
    E0[10, 9, i] <- ( 1-ALPHA[i, first[i]] ) * P0[i]
    E0[10, 10, i] <- 0
    E0[10, 11, i] <- ALPHA[i, first[i]] * ( 1-KHI[i, first[i]] ) * P0[i]
    E0[10, 12, i] <- 0
    E0[10, 13, i] <- 0
    E0[10, 14, i] <- KHI[i, first[i]] * ( 1-P0[i] )
    E0[10, 15, i] <- 0
    E0[10, 16, i] <- 0
    E0[10, 17, i] <- ALPHA[i, first[i]] * KHI[i, first[i]] * P0[i]
    E0[10, 18, i] <- 0
    E0[10, 19, i] <- 0
    ...
    E0[11, 7, i] <- 0
    E0[11, 8, i] <- 0
    E0[11, 9, i] <- 2 * ( 1-ALPHA[i, first[i]] ) * ALPHA[i, first[i]] * P0[i]
    E0[11, 10, i] <- ( 1-ALPHA[i, first[i]] )^2 * P0[i]
    E0[11, 11, i] <- ALPHA[i, first[i]]^2 * (1-KHI[i, first[i]]) * P0[i] 
    E0[11, 12, i] <- 0
    E0[11, 13, i] <- 0
    E0[11, 14, i] <- KHI[i, first[i]] * ( 1-P0[i] )
    E0[11, 15, i] <- 0
    E0[11, 16, i] <- 0
    E0[11, 17, i] <- ALPHA[i, first[i]]^2 * KHI[i, first[i]] * P0[i] 
    E0[11, 18, i] <- 0
    E0[11, 19, i] <- 0
    ...
    E0[12, 9, i] <- 0
    E0[12, 10, i] <- 0
    E0[12, 11, i] <- 1-KHI[i, first[i]]
    E0[12, 12, i] <- 0
    E0[12, 13, i] <- 0
    E0[12, 14, i] <- KHI[i, first[i]] * ( 1-P0[i] )
    E0[12, 15, i] <- 0
    E0[12, 16, i] <- 0
    E0[12, 17, i] <- KHI[i, first[i]] * P0[i] 
    E0[12, 18, i] <- 0
    E0[12, 19, i] <- 0
    ...
    E0[13, 9, i] <- 0
    E0[13, 10, i] <- 0
    E0[13, 11, i] <- 1-KHI[i, first[i]]
    E0[13, 12, i] <- 0
    E0[13, 13, i] <- 0
    E0[13, 14, i] <- 0
    E0[13, 15, i] <- KHI[i, first[i]] * ( 1-P0[i] )
    E0[13, 16, i] <- 0
    E0[13, 17, i] <- 0
    E0[13, 18, i] <- KHI[i, first[i]] * P0[i] 
    E0[13, 19, i] <- 0
    ...
    for (t in first[i]:(last[i] - 1)) {
      ...
      logit(phi[i, t]) <- h[1] * AGE_2_4[i, t] +
        h[2] * (AGE_YOUNG[i, t] + AGE_MIDDLE[i, t]) +
        h[3] * AGE_OLD[i, t] +
        h[4] * (SpUnk[i] + SpPel[i]) +
        h[5] * (AGE_2_4[i, t] + AGE_OLD[i, t]) * sea_ice_s[t] 
      
      # Probability of coy survival
      logit(s01[i, t]) <- f[1] * AGE_YOUNG_1[i, t] +
        f[2] * AGE_MIDDLE_1[i, t] +
        f[3] * AGE_OLD_1[i, t] +
        f[4] +
        f[5] * (SpUnk[i] + SpPel[i]) +
        f[6] * sea_ice_s[t] 
      
      logit(s02[i, t]) <- f[1] * AGE_YOUNG_1[i, t] +
        f[2] * AGE_MIDDLE_1[i, t] +
        f[3] * AGE_OLD_1[i, t] +
        f[5] * (SpUnk[i] + SpPel[i]) +
        f[6] * sea_ice_s[t] 
      ...
      logit(s1[i, t]) <- g[1] * AGE_YOUNG_2[i, t] +
        g[2] * AGE_MIDDLE_2[i, t] +
        g[3] * AGE_OLD_2[i, t] +
        g[4] * sea_ice_s[t] 
      
      # Denning probability
      logit(eta[i, t, 1]) <- e[1] * AGE_4[i, t] +   # Lone female
        e[2] * AGE_YOUNG[i, t] +
        e[3] * AGE_MIDDLE[i, t] +
        e[4] * AGE_OLD[i, t] +
        e[9] * sea_ice_s[t]
      
      logit(eta[i, t, 2]) <- e[2] * AGE_YOUNG[i, t] + # FDA
        e[3] * AGE_MIDDLE[i, t] +
        e[4] * AGE_OLD[i, t] +
        e[5] +
        e[9] * sea_ice_s[t]
      
      logit(eta[i, t, 3]) <- e[2] * AGE_YOUNG[i, t] + # A0-
        e[3] * AGE_MIDDLE[i, t] +
        e[4] * AGE_OLD[i, t] +
        e[6] +
        e[9] * sea_ice_s[t]
      
      logit(eta[i, t, 4]) <- e[2] * AGE_YOUNG[i, t] + # A1-
        e[3] * AGE_MIDDLE[i, t] +
        e[4] * AGE_OLD[i, t] +
        e[7] +
        e[9] * sea_ice_s[t]
      
      logit(eta[i, t, 5]) <- e[2] * AGE_YOUNG[i, t] + # AS
        e[3] * AGE_MIDDLE[i, t] +
        e[4] * AGE_OLD[i, t] +
        e[8] +
        e[9] * sea_ice_s[t]
      ...
      # Breeding success
      logit(beta[i, t]) <- a[1] * (AGE_4[i, t] + AGE_YOUNG[i, t]) +   
        a[2] * AGE_MIDDLE[i, t] +
        a[3] * AGE_OLD[i, t] +
        a[4] * DOY[i, t] +
        a[5] * DATE_OUT[i, t] +
      ...
      # Twinning prob
      logit(gamma[i, t]) <- b[1] * (AGE_4[i, t] + AGE_YOUNG[i, t]) +   
        b[2] * AGE_MIDDLE[i, t] +
        b[3] * AGE_OLD[i, t] +
        b[4] * (AGE_YOUNG[i, t] + AGE_4[i, t]) * DOY[i, t] +
        b[5] * (SpUnk[i] + SpPel[i]) +
        b[6] * DATE_OUT[i, t] +
        b[7] * sea_ice_s[t]
  ...
  #-------- State process --------#
  for (k in 1:3) {
    h[k] ~ dnorm(0, sd = 1.5)  # survival
  }
  h[4] ~ dnorm(0, sd = 3)  
  h[5] ~ dnorm(0, sd = 3)  
  
  for (k in 1:3) {
    f[k] ~ dnorm(0, sd = 1.5)  # CoY survival
  }
  for (k in 4:6) {
    f[k] ~ dnorm(0, sd = 1.5)  # CoY survival (additive effects)
  }
  
  
  for (k in 1:3) {
    g[k] ~ dnorm(0, sd = 1.5)  # yearling survival
  }
  g[4] ~ dnorm(0, sd = 3)
  
  # Constraint
  constraint_s0[1] ~ dconstraint(g[1] > f[1])
  constraint_s0[2] ~ dconstraint(g[2] > f[2])
  constraint_s0[3] ~ dconstraint(g[3] > f[3])
  
  for (k in 1:4) {
    e[k] ~ dnorm(0, sd = 1.5)  # denning probability (intercepts)
  }
  for (k in 5:9) {
    e[k] ~ dnorm(0, sd = 3)  # denning probability (additive effects)
  }
  
  
  for (k in 1:3) {
    a[k] ~ dnorm(0, sd = 1.5) # early litter survival (intercepts)
  }
  for (k in 4:6) {
    a[k] ~ dnorm(0, sd = 3) # early litter survival (additive effects)
  }
  
  for (k in 1:3) {
    b[k] ~ dnorm(0, sd = 1.5) # litter size (intercepts)
  }
  for (k in 4:7) {
    b[k] ~ dnorm(0, sd = 3) # litter size (additive effects)
  }
  ...
  for (k in 1:3) {
    c[k] ~ dnorm(0, sd = 1.5)    # coefs for date of entry (more informative prior on purpose)
  }
  sigma_day_in ~ dexp(1)
  for (k in 1:4) {
    d[k] ~ dnorm(0, sd = 3)  # coefs for date of emergence
  }
  sigma_day_out ~ dexp(1)
  
  # Yearly random effects on the timing of denning 
  for (t in 1:(n_occasions-1)) {
    psi[t] ~ dnorm(0, sigma_psi)
    rho[t] ~ dnorm(0, sigma_rho)
  }
  sigma_rho ~ dexp(1)
  sigma_psi ~ dexp(1)
  ...
  for(i in 1:n_ind){
    ...
    # First capture
    for (k in 1:n_states) {
      zeta[i, first[i], k] <- S0[k] * E0[k, CH[i, first[i]], i]
    }
    ...
    lik[i] <- sum(zeta[i, last[i], 1:n_states]) 
  ...
  for (k in 1:n_recaptured) {  # Physical recaptures
    ...
    mu_doy[index_recaptured_i[k], index_recaptured_t[k]] <- j[1] + 
      j[2] * DATE_OUT[index_recaptured_i[k], index_recaptured_t[k]] +
  ...
  for (i in 1:n_ind) {
    for (t in first[i]:(last[i] - 1)) {
      ...
      DATE_IN[i, t] ~ dnorm(mu_date_in[i, t], sd = sigma_day_in)
      
      CENSORED_OUT[i, t] ~ dinterval(t = DATE_OUT[i, t], c = DATE_OUT_BOUNDARY[i, t, ])
      DATE_OUT[i, t] ~ dnorm(mu_date_out[i, t], sd = sigma_day_out)   
...
MCMC_conf$removeSamplers(c('d[1]', 'd[2]', 'd[3]', 'd[4]'))
...
MCMC_conf$addSampler(target = c('d[1]', 'd[2]', 'd[3]', 'd[4]'), type = 'AF_slice')
...
params.plot <- c()
for (k in 1:5) {
  params.plot <- c(params.plot, paste0("h.", k, "."))
}
for (k in 1:4) {
...
for (k in 1:6) {
  params.plot <- c(params.plot, paste0("f.", k, "."))
}
for (k in 1:4) {
  params.plot <- c(params.plot, paste0("g.", k, "."))
}
for (k in 1:9) {
  params.plot <- c(params.plot, paste0("e.", k, "."))
}
for (k in 1:6) {
  params.plot <- c(params.plot, paste0("a.", k, "."))
}
for (k in 1:7) {
  params.plot <- c(params.plot, paste0("b.", k, "."))
}
for (k in 1:3) {
  params.plot <- c(params.plot, paste0("c.", k, "."))
}
params.plot <- c(params.plot, "sigma_rho", "sigma_day_in")
for (k in 1:4) {
  params.plot <- c(params.plot, paste0("d.", k, "."))
}
params.plot <- c(params.plot, "sigma_psi", "sigma_day_out")
for (k in 1:2) {
  params.plot <- c(params.plot, paste0("j.", k, "."))
}
